    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white p-8 rounded-lg shadow-md w-96">
            ...
            <form action="" method="POST">
                ...
                <div class="mt-4">
                    <button type="submit" class="bg-[#85581F] text-white px-4 py-2 rounded-md hover:bg-blue-600">Save</button>
                    <a href="{{route('address.index')}}" class="ml-2 text-gray-500 hover:text-gray-700">Cancel</a>
                </div>
            </form>
        </div>
    </div>
